    ...
    <div class="aset-container">
        <div class="main-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('aset.intra.edit', $item->id) }}" class="btn-action btn-edit">
                                                <img src="{{ asset('image/edit.png') }}" alt="Edit" style="width: 16px; height: 16px;">
                                            </a>

                                            <form action="{{ route('aset.intra.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="table-actions">
                <a href="{{ route('aset.intra.create') }}" class="btn-action btn-add">
