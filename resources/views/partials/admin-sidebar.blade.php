...
<div class="sidebar">
    ...
    <ul class="menu">
        <li><a href="{{ route('admin.dashboard') }}"><img src="{{ asset('image/dashboard.png') }}" class="icon"> <span class="menu-text">Dashboard</span></a></li>
        <li><a href="{{ route('admin.index') }}"><img src="{{ asset('image/aset.png') }}" class="icon"> <span class="menu-text">Aset</span></a></li>
        <li><a href="{{ route('admin.laporan.download') }}"><img src="{{ asset('image/file.png') }}" class="icon"> <span class="menu-text">Laporan</span></a></li>
        <li>
